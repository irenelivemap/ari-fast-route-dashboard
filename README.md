...
The service code lives in `dashboard-data-service/`. Once deployed, people can click **Load latest tests** in the dashboard after adding new benchmark results, without using GitHub.
